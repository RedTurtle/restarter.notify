...
@view_config(route_name='notify', renderer='json', request_param='email', request_method='POST')
...
@view_config(route_name='notify', renderer='json', request_param='phone', request_method='POST')
